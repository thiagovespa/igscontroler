...
//    m_ui->stack_LeftContents->setCurrentIndex(0);
    ...
    // Hide
//    m_ui->stack_LeftContents->setVisible(false);
...
void MainWindow::rotate(const Quantity_PlaneAngle x, const Quantity_PlaneAngle y, const Quantity_PlaneAngle z) {
	const GuiDocument* guiDoc = this->currentWidgetGuiDocument()->guiDocument();
	guiDoc->v3dView()->Rotate(x,y,z);
	guiDoc->v3dView()->Update();
}
